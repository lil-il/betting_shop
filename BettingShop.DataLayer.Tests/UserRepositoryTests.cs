...
namespace BettingShop.DataLayer.Tests
{
    ...
    public class UserRepositoryTests
    {
        ...
        public async Task CreateTest()
        {
            var repo = new UserRepository(new Deserializer());
            var user1 = new User
            { Id = Guid.NewGuid(), Balance = 1000, TelegramId = 15321};
        ...
        public async Task UpdateTest()
        {
            ...
            var user2 = new User
            { Id = user1.Id, Balance = 850, TelegramId = 15321};
        ...
        public async Task GetAllTest()
        {
            ...
            Thread.Sleep(1000);
            var user2 = new User
            { Id = Guid.NewGuid(), Balance = 1500, TelegramId = 15751 };
            await repo.CreateAsync(user2);
            Thread.Sleep(1000);
            var user3 = new User
            { Id = Guid.NewGuid(), Balance = 1500, TelegramId = 15754};
